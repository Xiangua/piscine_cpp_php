...
FragTrap::FragTrap(void) : _energypoint(100), _max_energypoint(100), _level(1), _melee_attack_dmg(30), _ranged_attack_dmg(20), _armor_dmg_reduction(5)
{
	...
	std::cout << "FR4G-TPX22 " << this->_name << " est vivant!" << std::endl;
}
...
{
	std::cout << "FR4G-TPX22 " << this->_name << " est mort . . ." << std::endl;
	*this = rf;
}
...
{
		std::cout << "FR4G-TPX22 " << this->_name << " attaque " << target << " a distance, et fait " <<  this->_ranged_attack_dmg   << " points de degats !" << std::endl;
}

void			FragTrap::meleeAttack(std::string const & target)
{

		std::cout << "FR4G-TPX22 " << this->_name << " attaque " << target << " au corp a corp, et fait " <<  this->_melee_attack_dmg << " points de degats !" << std::endl;
}
...
void			FragTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "FR4G-TPX22 " << this->_name << " est attaque est prend " <<  amount2  << " points de degats !" << std::endl;
}

void			FragTrap::beRepaired(unsigned int amount)
{
		this->setEnergypoint(this->getEnergypoint() + amount);
		std::cout << "FR4G-TPX22 " << this->_name << " est repare pour " <<  amount  << " points de vies !" << std::endl;
}

//
void			FragTrap::EyeAttack(std::string const & target, unsigned int amount)
{
		std::cout << "FR4G-TPX22 " << this->_name << " regard de tueur prend pour cible " << target << " et le fait souffrire pour " <<  amount   << " points de degats !" << std::endl;
}
void			FragTrap::FingerAttack(std::string const & target, unsigned int amount)
{
		std::cout << "FR4G-TPX22 " << this->_name << " quand le sage montre " << target << " l'idiot prend " <<  amount   << " points de degats !" << std::endl;
}
void			FragTrap::RightHandAttack(std::string const & target, unsigned int amount)
{
		std::cout << "FR4G-TPX22 " << this->_name << " parle a ma main " << target << " l'autre parlera a ta joue lui fesant " <<  amount   << " points de degats et de belles joues rouges!" << std::endl;
}
void			FragTrap::LeftLegAttack(std::string const & target, unsigned int amount)
{
		std::cout << "FR4G-TPX22 " << this->_name << " je chausse du 47 fillettes " << target << " ca va t'apprendre a rester debout tant ces " <<  amount   << " points de degats vont te faire mal au cul!" << std::endl;
}
void			FragTrap::PoopAttack(std::string const & target, unsigned int amount)
{
		std::cout << "FR4G-TPX22 " << this->_name << " Gogo gadget ô " << target << " ô poing dans ta gueules pour " <<  amount   << " points de degats !" << std::endl;
}
//
unsigned int			FragTrap::vaulthunter_dot_exe(std::string const & target)
{
	...
	{
		std::cout << "FR4G-TPX22 " << this->_name << " n'a plus asse de force pour botter le cul de " << target << " (OOM lol...)" << std::endl;
	}
	return 0;
}
